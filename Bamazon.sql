...
VALUES  ('Curl Cream', 'Cosmetics', 15.75, 500),
		...
		('Sony Headphones', 'Electronics', 99.99, 800),
		('8mm f/3.5 HD Fisheye Lens', 'Electronics', 197.00, 100),
		('Orange Juice', 'Grocery', 5.50, 267),
		('Ovaltine Malt, 12 Ounce', 'Grocery', 3.78, 200),
		('Lays Chips Variety Pack', 'Grocery', 22.00, 476),
		('Chips in Milk Chocolate', 'Grocery', 28.91, 575),
		...
		('Ben & Jerry Ice Cream', 'Grocery', 5.25, 432);
